...
describe("weekEnd", () => {
  it("gets the last day of the week", () => {
    expect(weekEnd("2022-11-28T00:00:00").toISOString()).toBe("2022-12-04T04:59:59.999Z");
  });
  it("gets the last day of the week when offset to tuesday", () => {
    expect(weekEnd("2022-07-08T00:00:00", 2).toISOString()).toBe("2022-07-12T03:59:59.999Z");
  });
  it("gets the last day of the week when offset to wednesday and the day is thursday", () => {
    expect(weekEnd("2022-10-13", 3).toISOString()).toBe("2022-10-19T03:59:59.999Z");
  });
  it("gets the last day of the week when offset to wednesday and the day is monday", () => {
    expect(weekEnd("2022-10-10", 3).toISOString()).toBe("2022-10-12T03:59:59.999Z");
  });
